...
addBtn.addEventListener('click', () => {
    ...
    <li>
        <button class="li-btn">
            <svg id="unchecked-box" version="1.1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 512 512">
        ...
        <button class="li-btn">
            <svg id="edit" version="1.1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 512 512">
        ...
        <button class="li-btn">
            <svg id="trash" version="1.1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 512 512">
